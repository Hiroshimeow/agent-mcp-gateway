...
test('runtime dependencies exclude test-only or unused MCP helper packages', () => {
  ...
  assert.equal(packageJson.devDependencies?.['@modelcontextprotocol/server-filesystem'], '2026.1.14');
});
