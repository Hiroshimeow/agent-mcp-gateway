...
function renderSessionRows(items, csrf) {
  if (!items.length) return '<tr><td colspan="5" class="empty">No OAuth client sessions.</td></tr>';
...
.sessions-table .session-client{min-width:360px}.session-client form{display:flex;gap:8px;align-items:center;margin-top:6px}.session-client form input{min-width:220px}.session-devices{display:flex;flex-wrap:wrap;gap:6px 12px;align-items:center;margin-top:9px}.session-device{display:inline-flex;align-items:baseline;gap:6px;white-space:nowrap;padding:3px 7px;border:1px solid var(--line);border-radius:4px;background:#0a0e13}.session-device small{display:inline;margin:0}.sessions-table td:last-child form{margin:0}
</style></head><body><main>
