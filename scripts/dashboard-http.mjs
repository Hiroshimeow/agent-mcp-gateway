...
<section><h2>Devices</h2><table><thead><tr><th>Device</th><th>Platform / agent</th><th>Last seen</th><th>Calls</th><th>OK / Fail</th><th>Input</th><th>Output</th><th>Est. I/O tokens</th><th>Controls</th></tr></thead><tbody>${renderDeviceRows(devices, csrf)}</tbody></table></section>
