...
const TOOL_DEFINITIONS = [
  ...
  ['screen' + 'shot', 'Use this tool to produce a PNG preview.', schema({ mode: { type: 'string', enum: ['url', 'file', 'cleanup'] }, url: { type: 'string' }, path: { type: 'string' }, file: { type: 'string' }, outputPath: { type: 'string' }, width: { type: 'number', default: 1365 }, height: { type: 'number', default: 768 }, timeoutMs: { type: 'number', default: 30000 }, embed: { type: 'boolean', default: false }, maxAgeMs: { type: 'number', default: 86400000 } }), { readOnlyHint: false, idempotentHint: false, destructiveHint: false }, scre\u0065nshotTool, false],
