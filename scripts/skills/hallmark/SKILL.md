---
name: hallmark
description: "Use when the user explicitly invokes Hallmark, requests anti-AI-slop UI design, or asks for a Hallmark audit, redesign, or study of a page, screenshot, or URL."
version: 1.1.0
---
...
The per-theme axis values live as comments at the top of each theme's tokens block in [`site/css/tokens.css`](references/upstream/tokens.css). When in doubt, name your candidate theme out loud and identify its three axis values; if two of three match the previous output, redirect.
...
- [`references/upstream/recipes.md`](references/upstream/recipes.md) — eight worked briefs for human readers.
- [`references/upstream/study-examples.md`](references/upstream/study-examples.md) — three worked DNA-extractions for human readers.
