...
**Personal skills live in your runtime's configured skills directory.** For cross-runtime project-local skills, prefer `.agents/skills/` when the harness supports it.
