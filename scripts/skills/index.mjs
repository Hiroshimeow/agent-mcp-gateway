const SKILLS = new Map([
  ...
  ['using_superpowers', {
    ...
    body: [
      ...
      '- custom_get_skill: the reliable read-only loader a normal agent can call by name.',
      '',
      '## Load Protocol',
      '',
      ...
      '2. Check whether a registered skill applies. If there is even a reasonable chance, call custom_get_skill with the smallest relevant skill name or alias.',
      '3. Read the returned skill body once, keep it in task context, and do not call custom_get_skill again for that same skill in the same task unless the user asks to refresh.',
