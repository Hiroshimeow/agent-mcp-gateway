...
name: claude-api
description: |-
  Use when implementing, debugging, or answering questions about the Claude API or Anthropic SDK, including Claude model selection, parameters, streaming, tool use, MCP, agents, caching, token counting, or migration. Use when Claude or Anthropic is the target provider; do not use for other named LLM providers.
